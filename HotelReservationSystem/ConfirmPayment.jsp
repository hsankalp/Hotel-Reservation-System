	...
	<section id="content">
		...
		<article class="expanded">
		 <%
			...
			String receiptNo = String.valueOf(t);
			
			
		%>	
		
		<h3> Payment Successful. Your receipt number is <%= receiptNo %> </h3>
		<h3> Please show this receipt number during your check out at hotel reception. </h3>	
