...
<div id="container" >
	...
	<section id="content">
		...
		<%
			...
			int mDays = Integer.parseInt(request.getParameter("mDays"));
			String rType = request.getParameter("rType");
			//int finalPrice = mDays * mPrice;;
			int finalPrice = mDays * mCount * mPrice;
		%>


			<h3>Confirmation on the Meal Booking - <%= rType %> </h3>
		...
		<article class="expanded">
			...
			<form class = "submit-button" method = "get" action = "ConfirmMeal.jsp">
